...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'front_order', 'created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Order.created'
        db.alter_column(u'front_order', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
